...
def upgrade() -> None:
    ...
    op.execute(
        f"INSERT INTO user (username, email, password, is_manager, profile_picture, creation_date) VALUES ('{os.getenv('USERNAME_ADMIN')}', 'admin@gmail.com', '{get_password_hash(os.getenv('PASSWORD_ADMIN'))}', 1, null, '{datetime.now()}');")
    ...
    op.create_table('chante',
                    ...
                    sa.ForeignKeyConstraint(
                        ['author_id'], ['author.id'], name='chante_ibfk_1'),
                    sa.ForeignKeyConstraint(
                        ['music_id'], ['music.id'], name='chante_ibfk_2'),
    ...
    op.create_table('review',
                    ...
                    sa.ForeignKeyConstraint(
                        ['music_id'], ['music.id'], name='review_ibfk_2'),
                    sa.ForeignKeyConstraint(
